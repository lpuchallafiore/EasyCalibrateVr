...
public:
  ...
  typedef std::shared_ptr<ProjectionVRCamera> Ref;
  ...
  */
  ProjectionVRCamera(DisplayTile dispTile, G3D::CoordinateFrame initHeadFrame,
  ...
  void applyProjection(G3D::RenderDevice *rd, EyeProjectionType whichEye, G3D::GCamera* cam = nullptr);
